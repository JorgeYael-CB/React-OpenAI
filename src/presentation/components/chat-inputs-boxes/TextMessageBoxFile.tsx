...
export const TextMessageBoxFile = ( {onSendMessage, disabledCorrection = false, placeholder = '', accept}: Props ) => {
  ...
  return (
    ...
    <div className="mr-3">
      <button className="flex items-center justify-center text-gray-400 hover:text-gray-600" type="button" onClick={ () => inputFileRef.current?.click() }>
